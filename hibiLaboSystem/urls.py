...
urlpatterns = [
	...
	path('mandara-print', views.MandaraPrint.as_view(), name='mandara_print'), #print PDF
    ...
    path('mandara-completion-detail', views.MandaraCompletionDetail.as_view(), name='mandara_completion_detail'), #Display 5
]