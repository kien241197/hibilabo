...
class MandaraPeriod(models.Model):
	...
	input_start_date = models.DateField(null=True, blank=False, verbose_name="評価入力開始期間")
	input_end_date = models.DateField(null=True, blank=False, verbose_name="評価入力終了期間")
